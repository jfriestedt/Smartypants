...
Vote.create!(
  value: 1, voter_id: User.all[0].id, annotation_id: Annotation.all[0].id
)
Vote.create!(
  value: 1, voter_id: User.all[0].id, annotation_id: Annotation.all[1].id
)
Vote.create!(
  value: 1, voter_id: User.all[0].id, annotation_id: Annotation.all[2].id
)
Vote.create!(
  value: 1, voter_id: User.all[0].id, annotation_id: Annotation.all[3].id
)
Vote.create!(
  value: 1, voter_id: User.all[0].id, annotation_id: Annotation.all[4].id
)
Vote.create!(
  value: 1, voter_id: User.all[0].id, annotation_id: Annotation.all[10].id
)
Vote.create!(
  value: 1, voter_id: User.all[0].id, annotation_id: Annotation.all[9].id
)
Vote.create!(
  value: 1, voter_id: User.all[0].id, annotation_id: Annotation.all[8].id
)
Vote.create!(
  value: 1, voter_id: User.all[0].id, annotation_id: Annotation.all[11].id
)
Vote.create!(
...
Vote.create!(
  value: -1, voter_id: User.all[1].id, annotation_id: Annotation.all[18].id
)
Vote.create!(
  value: -1, voter_id: User.all[1].id, annotation_id: Annotation.all[17].id
)
Vote.create!(
  value: 1, voter_id: User.all[1].id, annotation_id: Annotation.all[20].id
)
Vote.create!(
  value: 1, voter_id: User.all[1].id, annotation_id: Annotation.all[4].id
)
Vote.create!(
  value: -1, voter_id: User.all[1].id, annotation_id: Annotation.all[21].id
)
Vote.create!(
  value: 1, voter_id: User.all[1].id, annotation_id: Annotation.all[24].id
)
Vote.create!(
  value: 1, voter_id: User.all[1].id, annotation_id: Annotation.all[8].id
)
Vote.create!(
  value: 1, voter_id: User.all[1].id, annotation_id: Annotation.all[25].id
)
Vote.create!(
  value: 1, voter_id: User.all[1].id, annotation_id: Annotation.all[26].id
)
Vote.create!(
  value: 1, voter_id: User.all[1].id, annotation_id: Annotation.all[30].id
)
Vote.create!(
  value: -1, voter_id: User.all[1].id, annotation_id: Annotation.all[13].id
)
Vote.create!(
  value: -1, voter_id: User.all[1].id, annotation_id: Annotation.all[29].id
)
Vote.create!(
...
Vote.create!(
  value: 1, voter_id: User.all[2].id, annotation_id: Annotation.all[19].id
)
Vote.create!(
  value: 1, voter_id: User.all[2].id, annotation_id: Annotation.all[3].id
)
Vote.create!(
  value: -1, voter_id: User.all[2].id, annotation_id: Annotation.all[32].id
)
Vote.create!(
  value: 1, voter_id: User.all[2].id, annotation_id: Annotation.all[33].id
)
Vote.create!(
  value: -1, voter_id: User.all[2].id, annotation_id: Annotation.all[12].id
)
Vote.create!(
